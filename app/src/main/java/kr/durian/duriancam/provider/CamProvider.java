...
public class CamProvider extends ContentProvider {
    ...
    private CamSQLiteHelper mParkingHelper;
    ...
    public boolean onCreate() {
        mParkingHelper = new CamSQLiteHelper(getContext());
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            case PARKING_TABLE: {
                ...
                result = database.query(CamSQLiteHelper.TABLE_PARKING_LIST, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            }
            case USER_TABLE: {
                SQLiteDatabase database = mParkingHelper.getReadableDatabase();
                result = database.query(CamSQLiteHelper.TABLE_USER_LIST, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            }
        }
        return result;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        switch (uriMatcher.match(uri)) {
            case PARKING_TABLE: {
                ...
                long newId = database.insert(CamSQLiteHelper.TABLE_PARKING_LIST, null, values);

                return uri.parse(PARKING_TABLE_URI.toString() + "/?newid=" + newId);
            }
            case USER_TABLE: {
                SQLiteDatabase database = mParkingHelper.getWritableDatabase();
                long newId = database.insert(CamSQLiteHelper.TABLE_USER_LIST, null, values);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        switch (uriMatcher.match(uri)) {
            case PARKING_TABLE: {
                SQLiteDatabase database = mParkingHelper.getWritableDatabase();
                int deleted = database.delete(CamSQLiteHelper.TABLE_PARKING_LIST, selection, selectionArgs);
            ...
            case USER_TABLE: {
                SQLiteDatabase database = mParkingHelper.getWritableDatabase();
                int deleted = database.delete(CamSQLiteHelper.TABLE_USER_LIST, selection, selectionArgs);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            case PARKING_TABLE: {
                SQLiteDatabase database = mParkingHelper.getWritableDatabase();
                count = database.update(CamSQLiteHelper.TABLE_PARKING_LIST, values, selection, selectionArgs);

                break;
            }
            case USER_TABLE: {
                SQLiteDatabase database = mParkingHelper.getWritableDatabase();
                count = database.update(CamSQLiteHelper.TABLE_USER_LIST, values, selection, selectionArgs);
